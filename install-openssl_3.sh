...
# Get openssl tarball
# curl -O --silent https://www.openssl.org/source/openssl-3.4.1.tar.gz
wget https://www.openssl.org/source/openssl-3.4.1.tar.gz

# SPEC file
cat << 'EOF' > ~/openssl/openssl3.spec
Summary: OpenSSL 3.4.1 for Centos
Name: openssl
Version: %{?version}%{!?version:3.4.1}
Release: 1%{?dist}
...
OpenSSL RPM for version 3.4.1 on CentOS
...
%description devel
OpenSSL RPM for version 3.4.1 on CentOS (development package)
...
mv openssl-3.4.1.tar.gz /root/rpmbuild/SOURCES
