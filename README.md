...
# OpenSSL 3.5.2 [release page](https://github.com/openssl/openssl/releases/tag/openssl-3.5.2):
...
```bash
sudo rpm -ivvh /root/rpmbuild/RPMS/x86_64/openssl-3.5.2-1.el7.x86_64.rpm --nodeps
 ```
